package com.better.cloud.gateway.handler;
 ...
 */
@Slf4j
public class BetterGatewayExceptionHandler extends DefaultErrorWebExceptionHandler {

    public BetterGatewayExceptionHandler(ErrorAttributes errorAttributes, ResourceProperties resourceProperties,
