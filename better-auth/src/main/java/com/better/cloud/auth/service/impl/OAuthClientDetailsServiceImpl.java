...
import com.better.cloud.auth.mapper.OAuthClientDetailsMapper;
...
public class OAuthClientDetailsServiceImpl extends ServiceImpl<OAuthClientDetailsMapper, OAuthClientDetails> implements OAuthClientDetailsService {
    ...
    @Override
    @Transactional
    public void createOAuthClientDetails(OAuthClientDetails oauthClientDetails) throws BetterException {
        OAuthClientDetails byId = this.findById(oauthClientDetails.getClientId());
        if (byId != null) {
            throw new BetterException("该Client已存在");
        }
