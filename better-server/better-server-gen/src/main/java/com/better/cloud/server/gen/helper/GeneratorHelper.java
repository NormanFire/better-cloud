package com.better.cloud.server.gen.helper;

import com.alibaba.fastjson.JSONObject;
import com.better.cloud.common.annotation.Helper;
...
import com.better.cloud.common.utils.AddressUtil;
...
public class GeneratorHelper {
    ...
    public void generateEntityFile(List<Column> columns, GeneratorConfig configure) throws Exception {
        ...
        columns.forEach(c -> {
            c.setField(BetterUtil.underscoreToCamel(StringUtils.lowerCase(c.getName())));
    ...
    public void generateMapperXmlFile(List<Column> columns, GeneratorConfig configure) throws Exception {
        ...
        JSONObject data = toJSONObject(configure);
        columns.forEach(c -> c.setField(BetterUtil.underscoreToCamel(StringUtils.lowerCase(c.getName()))));
        data.put("columns", columns);
    ...
    private Template getTemplate(String templateName) throws Exception {
        ...
        if (!file.exists()) {
            templatePath = System.getProperties().getProperty(BetterConstant.JAVA_TEMP_DIR);
        ...
        configuration.setDefaultEncoding(BetterConstant.UTF8);
