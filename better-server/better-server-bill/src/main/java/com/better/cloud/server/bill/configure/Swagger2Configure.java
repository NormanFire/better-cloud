package com.better.cloud.server.bill.configure;

import com.better.cloud.server.bill.properties.BetterServerBillProperties;
import com.better.cloud.server.bill.properties.SwaggerProperties;
...
/**
 * @author lius
 * @description 配置swagger与swagger Oauth2
 * @date 2020/2/21
 */
@Configuration
@EnableSwagger2
public class Swagger2Configure {
    @Autowired
    private BetterServerBillProperties properties;
