...
import ${basePackage}.common.entity.BetterResponse;
import ${basePackage}.common.exception.BetterException;
...
public class ${className}Controller extends BaseController {
    ...
    public BetterResponse getAll${className}s(${className} ${className?uncap_first}) {
        return new BetterResponse().data(${className?uncap_first}Service.find${className}s(${className?uncap_first}));
    }

    @GetMapping("list")
    @PreAuthorize("hasAuthority('${className?uncap_first}:list')")
    public BetterResponse ${className?uncap_first}List(QueryRequest request, ${className} ${className?uncap_first}) {
    ...
    public void add${className}(@Valid ${className} ${className?uncap_first}) throws BetterException {
        try {
    ...
    public void delete${className}(${className} ${className?uncap_first}) throws BetterException {
        try {
    ...
    public void update${className}(${className} ${className?uncap_first}) throws BetterException {
        try {
